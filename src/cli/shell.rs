...
fn show_help() {
    ...
    println!("    {} network -t <ip> --ports 1-8080    Custom port range", tc("➥", t));
    ...
    println!("    {} listen --lport 4444        Start listener on port", tc("➥", t));
    println!("    {} sessions                  List active sessions", tc("➥", t));
    println!("    {} proxy-scrape              Scrape & test proxies", tc("➥", t));
    println!();
